...
!!$***********************************************************************
!!$   Time-stamp: <2007-09-27 11:59:24 marchi>                           *
!!$                                                                      *
!!$                                                                      *
!!$                                                                      *
!!$======================================================================*
...
!!$------------------------- LOCAL VARIABLES ----------------------------*
  ...
  INTEGER, SAVE :: kread=-1,kbin=-1,Corr_Max=-1,n_Max=-1
...
!!$----------------------- EXECUTABLE STATEMENTS ------------------------*
  ...
  WRITE(*,'(''#      Time         Dip Rank 1                Dip Rank 2             <|r(t)-r(0)|^2>'')')
  DO i=0,n-1
...
!!$----------------------- EXECUTABLE STATEMENTS ------------------------*
    ...
    IF(.NOT. ok) THEN
       ...
       errmsg='Usage: '// command(1:nchars) //' dynamic_file [input ] [ > output ]'
       WRITE(*,'(a)') errmsg
       STOP
    END IF
