!!$***********************************************************************
!!$   Time-stamp: <2006-12-20 15:09:32 marchi>                           *
!!$                                                                      *
!!$                                                                      *
!!$                                                                      *
!!$======================================================================*
...
MODULE Linked_Char
  ...
  TYPE :: NODE_Char
     ...
     TYPE(NODE_Char), POINTER :: next=>NULL()
  END TYPE NODE_Char
  TYPE(NODE_Char), POINTER :: root
  TYPE(NODE_Char), POINTER :: current
  INTEGER, SAVE :: count_a=0
CONTAINS
  SUBROUTINE Start()
    IMPLICIT none
  ...
  SUBROUTINE Add(labels, count_out)
    ...
    INTEGER, INTENT(OUT) :: count_out
    INTEGER :: kk
    TYPE(NODE_Char), POINTER :: new_node
  ...
  SUBROUTINE Extract(labs,end_of_list, init)
    IMPLICIT none
    INTEGER, OPTIONAL :: init
    CHARACTER(len=max_char), INTENT(OUT) :: labs
    LOGICAL, INTENT(OUT)  :: end_of_list
    IF(PRESENT(init)) THEN
       IF(init == 0) current=>root
    END IF
  ...
  END SUBROUTINE Cleanup
  RECURSIVE SUBROUTINE Remove(old_node)
    TYPE(NODE_Char), POINTER :: old_node
    INTEGER, SAVE :: uppa=0
