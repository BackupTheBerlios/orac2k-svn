      SUBROUTINE calc_avg_str(anprot,annpro,anpoint,protl,wca,xp_ini,
     &     yp_ini,zp_ini,xp_avg,yp_avg,zp_avg,qt,xp0,yp0,zp0,nato,
     &     iter_avg)
...
*----------------------------- ARGUMENTS ------------------------------*
     ...
     &     ,zp_ini(*),xp_avg(*),yp_avg(*),qt(4)
     &     ,zp_avg(*)
      INTEGER annpro,anpoint(2,*),protl(*),nato,iter_avg
      LOGICAL anprot
      ...
      IF(anprot) THEN
         DO n=1,annpro
            ...
            IF(DABS(sum) .GT. 1.0D-3) THEN
               ...
               DO l=1,m
                  i=anpoint(1,n)-1+l
                  xp_avg(i)=xp_avg(i)+xyzfit(1,l)
                  yp_avg(i)=yp_avg(i)+xyzfit(2,l)
                  zp_avg(i)=zp_avg(i)+xyzfit(3,l)
               END DO
            END IF
         END DO
