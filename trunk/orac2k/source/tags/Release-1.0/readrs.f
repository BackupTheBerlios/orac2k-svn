      SUBROUTINE readrs(kdump,file,nstep,temp,ntap,ngrp,nprot,xp0,yp0
     &     ,zp0,vpx,vpy,vpz,gh,vh,nh,hoover,avg1,avg2,na1,na2,co,oc
     &     ,cpress,zz,igr,krdf,igrn,igrnmax)
...
*==================== EXECUTABLE STATEMENTS ============================
     ...
     &        //' insufficient. Abort.'
      ...
      END IF
      IF(cpress) THEN
         READ(kdump,END=100,ERR=100) ((zz(i,j),j=1,3),i=1,3)
      END IF
